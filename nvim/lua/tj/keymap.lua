...
require("tj.keymap")
L = {}
L.n = vim.keymap.nnoremap
L.v = vim.keymap.vnoremap
L.x = vim.keymap.xnoremap
L.o = vim.keymap.onoremap
L.i = vim.keymap.inoremap
L.l = vim.keymap.lnoremap
L.c = vim.keymap.cnoremap
L.t = vim.keymap.tnoremap
--]]
